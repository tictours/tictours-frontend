                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <div className="invoice-btn">
                                        <button onClick={()=>setShowModal(true)} className="btn btn-primary">New User Role <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
