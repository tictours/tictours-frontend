...
const tableBlog = [
    {  title:'Talan Siphron',  mail:'ahmad@mail.com', icon:'#1EBA62', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Confirmed'},
    ...
    {  title:'Marilyn Workman',  mail:'mantha@mail.com',icon:'#FF4646', iconClass:'btn-pink', icon2: <QuestionIcon colorchange="#EB62D0" />, icontext:'W. Approval'  },
    ...
    {  title:'Marilyn Workman',  mail:'adja@mail.com',icon:'#FF4646', iconClass:'btn-pink', icon2: <QuestionIcon colorchange="#EB62D0" />, icontext:'W. Approval'  },
    {  title:'Thomas Khun',  mail:'soap@mail.com', icon:'#FF4646', iconClass:'btn-primary', icon2: <QuestionIcon colorchange="#01A3FF" />, icontext:'Pending'   },
    {  title:'Talan Siphron',  mail:'kevin@mail.com',icon:'#FF4646', iconClass:'btn-pink', icon2: <QuestionIcon colorchange="#EB62D0" />, icontext:'W. Approval'  },
    {  title:'Marilyn Workman',  mail:'vita@mail.com' , icon:'#1EBA62', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Complete' },
];
const bigCardData = [
    {id:'1', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 1'},
    {id:'2', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 2'},
    {id:'3', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 3'},
    {id:'4', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 4'},
    {id:'5', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 5'},
    {id:'6', image:course1, title:'India, Edappally ,Kochi Kerala', name:'Hotel 6'},
];
                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <div className="invoice-btn">
                                        <button onClick={()=>navigate(`/add-hotel`)} className="btn btn-primary">New Hotels <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
