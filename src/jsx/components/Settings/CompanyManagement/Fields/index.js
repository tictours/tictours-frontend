...
const Fields = () =>{
   ...
   // Active paggination & chage data
    ...
    const MENU = ['source','status','category']
    return (
        <>
            <div className="row">
                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <Dropdown className="me-2 drop-select">
                                        ...
                                        <Dropdown.Menu>
                                            {fieldOptions.map((type,key)=>(
                                                <Dropdown.Item key={key} onClick={()=>setSelectBtn(type)}>{type}</Dropdown.Item>
                                    ...
                                    <div className="invoice-btn">
                                        <button onClick={()=>setShowModal(true)} className="btn btn-primary">New Fields<svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
