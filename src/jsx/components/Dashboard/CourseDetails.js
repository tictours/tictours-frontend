              ...
              <div className="video-img style-1">
                <div className="view-demo">
                  ...
                  <div className="play-button text-center">
                    <Link
                      to={"#"}
                      href="https://www.youtube.com/watch?v=e6MhFghdQps"
              ...
              <div className="course-details-tab style-2 mt-4">
                <Tab.Container defaultActiveKey={"About"}>
                  ...
                  >
                    ...
                    <Nav.Link className="nav-link" eventKey="Discuss">
                      Discussion
                    </Nav.Link>
                  </Nav>
                  <Tab.Content>
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="ms-3">
                              ...
                              <ul className="d-flex align-items-center raiting my-0 flex-wrap">
                                <li>
                                  <span className="font-w500">5.0</span>
                                  <i className="fas fa-star star-orange ms-2"></i>
          ...
          <div className="modal-body post-input mb-0	">
            <div className="row">
              <div className="col-xl-12 mb-4">
                ...
                <Link to={"#"} className="btn-social facebook me-1">
                  <i className="fab fa-facebook-f"></i>
                </Link>
                <Link to={"#"} className="btn-social google-plus me-1">
                  <i className="fab fa-google-plus-g"></i>
                </Link>
                <Link to={"#"} className="btn-social linkedin me-1">
                  <i className="fab fa-linkedin-in"></i>
                </Link>
                <Link to={"#"} className="btn-social instagram me-1">
                  <i className="fab fa-instagram"></i>
                </Link>
                <Link to={"#"} className="btn-social twitter me-1">
                  <i className="fab fa-twitter"></i>
                </Link>
                <Link to={"#"} className="btn-social youtube me-1">
                  <i className="fab fa-youtube"></i>
                </Link>
                <Link to={"#"} className="btn-social whatsapp me-1">
              ...
              <div className="col-xl-12">
                ...
                <div className="input-group mb-3">
                  ...
                  />
                  <div
                    className="input-group-prepend ms-3 c-pointer"
                    onClick={copyToClipboard}
                  >
                    <span className="input-group-text" id="copy">
                      Copy
                    </span>
                  </div>
                </div>
