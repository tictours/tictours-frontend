...
const bigCardData = [
  {
    id: "1",
    image: course1,
    title: "Jack and Sally",
    name: "Bitcoin and Cryptocurrencies Technologies",
  },
  {
    id: "2",
    image: course2,
  ...
  },
  {
    ...
    image: course3,
    title: "Karen Hope",
    name: "Blockchain – Principles and Practices",
  },
  {
    id: "4",
    image: course4,
  ...
  },
  {
    ...
    image: course10,
    title: "Jordan Nice",
    name: "Candlestick Chart Patterns",
  },
  {
    id: "8",
    image: course11,
    title: "Johnny Ahmad",
    name: "Cryptocurrency Foundation",
  },
];
function CourseList() {
  ...
  return (
    <>
                  ...
                  <div className="h-100">
                    <div className="dlab-info">
                      <div className="dlab-title d-flex justify-content-between">
                        <div>
                          <h4>
                            <Link to={"/course-details"}>{item.name}</Link>
                          </h4>
                          <div className="">
                            <p className="m-0">
                              {item.title}
                      ...
                      <div className="d-flex justify-content-between content align-items-center">
                        <span>
                          <img src={bitcoin} alt="" /> 110+ Content
                        </span>
                        <Link
                          to={"/course-details"}
      ...
      <div className="table-pagenation mb-3">
        <p className="ms-0">
          Showing <span>1-8</span>from <span>20</span>data
        </p>
        <nav>
