                      ...
                      <div className="d-flex align-items-center">
                        <Dropdown className="me-4 drop-select">
                          ...
                          <Dropdown.Menu>
                            ...
                            <Dropdown.Item
                              onClick={() => setSelectBtn("This Weeks")}
                            >
                              This Weeks
                            </Dropdown.Item>
                            <Dropdown.Item
                              onClick={() => setSelectBtn("Today")}
                            >
                              Today
                            </Dropdown.Item>
                          </Dropdown.Menu>
                            ...
                            {lastestTable.map((item, ind) => (
                              <tr key={ind}>
                                ...
                                <td className="text-end">
                                  <span
                                    className={`btn light  btn-sm ${item.iconClass}`}
                                  >
                                    {item.icon2} {item.icontext}
                                  </span>
                                </td>
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card event-agenda  h-auto">
                    ...
                    <div
                      className="card-body loadmore-content  recent-activity-wrapper p-3 pt-0"
                      id="RecentActivityContent"
                    >
                      {eventBlog.map((data, ind) => (
                        <div
                          className="d-flex align-items-center event"
                          key={ind}
                        >
                    ...
                    <div className="card-footer text-center border-0 pt-0">
                      <Link
                        to={"#"}
                        className="btn btn-block light btn-secondary  dlab-load-more"
                        id="RecentActivity"
                      >
                        View More
                      </Link>
