...
import { IconFirst, IconSecond, IconThird, IconFourth } from "./Crypto/Icon";
...
const sellingData = [{ title: "Sell" }, { title: "Buy" }];
                  ...
                  <div className="card market-previews">
                    ...
                    <div className="card-body pt-0 px-0">
                      {MarketData.map((data, index) => (
                        <div
                          className={`previews-info ${data.headClass}`}
                          key={index}
                        >
                          <div className="pre-icon">
                            <span className="icon">{data.IconBlog}</span>
                            <div>
                          ...
                          <div className="form_exchange">
                            ...
                            <div className="crypto-select">
                              <Dropdown className="drop-select">
                                <Dropdown.Toggle
                                  as="div"
                                  className="i-false drop-select-btn style-2"
                                >
                                  {selectBtn2}{" "}
                                  <i className="fa-solid fa-angle-down"></i>
                                </Dropdown.Toggle>
                                <Dropdown.Menu>
                                  <Dropdown.Item
                                    onClick={() => setSelectBtn2("Year")}
                                  >
                                    Year
                                  </Dropdown.Item>
                                  <Dropdown.Item
                                    onClick={() => setSelectBtn2("Weeks")}
                                  >
                                    Weeks
                                  </Dropdown.Item>
                                  <Dropdown.Item
                                    onClick={() => setSelectBtn2("Day")}
                                  >
                                    Day
                                  </Dropdown.Item>
                                </Dropdown.Menu>
