    ...
    <>
      <div className="card draggable-handle draggable">
        <div className="card-body">
          ...
          <p className="font-w600 fs-18">
            <Link to={"#"} className="text-black">
              {subtitle}
            </Link>
          </p>
          <span>
            Task Done: <strong className={`text-${badge}`}>5/10</strong>
          </span>
          <div className="progress default-progress mb-3 mt-2">
            <div
              className={`progress-bar progress-animated bg-${badge}`}
                      ...
                      {(draggableProvided) => (
                        ...
                        >
                          <div className="card-body">
                            <div className="kanban-user">
                              <span
                                className={`badge light badge-${task.select}`}
                              >
                                {task.maintitle}
                              </span>
                              <ul className="users">
                            ...
                            <span>
                              Task Done:{" "}
                              <strong className={`text-secondary`}>5/10</strong>
                            </span>
                            <div className="progress default-progress mb-3 mt-2">
                              <div
                                className={`progress-bar progress-animated bg-${task.select} `}
                                style={{ width: "45%", height: "8px" }}
                                role="progressbar"
                              >
                                <span className="sr-only">45% Complete</span>
