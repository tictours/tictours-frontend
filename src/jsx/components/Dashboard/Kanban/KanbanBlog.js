...
function HeadOne({ title }) {
  return (
    <>
      <div
        className={`sub-card align-items-center d-flex justify-content-between mb-2`}
      >
        <div>
        ...
        <Dropdown className="custom-dropdown ms-2">
          <Dropdown.Toggle
            as="div"
            className="btn sharp btn-primary tp-btn sharp-sm i-false"
          >
            <svg
...
const initialData = {
  tasks: {
    ...
    5: {
      id: 5,
      dropid: "105",
      content: "Create a Content",
      maintitle: "Copywriting",
      select: "danger",
    },
    6: {
      id: 6,
      dropid: "106",
      content: "Create a Caption",
      maintitle: "Design",
      select: "pink",
    },
    7: {
