                    ...
                    <div className="user-details">
                      ...
                      <div className="side-detail">
                        <div className="edit-profiil">
                          <button className="btn light btn-primary btn-sm text-nowrap">
                            Edit Profile
                          </button>
                        </div>
                        <Dropdown className="dropdown ms-auto">
                          <Dropdown.Toggle
                            as="div"
                            className="i-false btn sharp btn-primary tp-btn"
              ...
              <div className="card pie-chart2">
                <div className="card-header border-0">
                  ...
                  <div className="d-flex align-items-center">
                    <div className="coman-btn me-2">
                      <button
                        type="button"
                        className="btn light btn-primary btn-sm mx-1"
                      >
                        Chart
                      </button>
                      <button
                ...
                <div className="card-body">
                  ...
                  <div className="chart-info">
                    ...
                    <div>
                      <Link to={"#"} className="btn light btn-primary">
                        Learn More
                      </Link>
                    </div>
                  </div>
          ...
          <div className="row">
                      ...
                      >
                        ...
                        >
                          <rect
                            width="438"
                            height="283"
                            fill="url(#paint0_linear_51_1209)"
                          />
                        </mask>
                        <g mask="url(#mask0_51_1209)">
                          <path
                            d="M165 410.5H15L465.5 88H487.5L165 410.5Z"
                            fill="#ccecff"
                          />
                          <path
                            d="M264 369.5H114L564.5 47H586.5L264 369.5Z"
                            fill="#ccecff"
                          />
                        </g>
                        <defs>
                          <linearGradient
                            id="paint0_linear_51_1209"
                            x1="308.075"
                            y1="-143.042"
                            x2="316.634"
                            y2="468.334"
            ...
            <div className="col-xl-12">
              <div className="card messages ">
                ...
                <div
                  className="card-body loadmore-content  recent-activity-wrapper p-4"
                ...
                >
                  ...
                  {messageBlog.map((data, ind) => (
                    ...
                    >
                      ...
                      <div className="user-info">
                        <h6 className="name">
                          <Link to={"post-details"}>{data.title}</Link>
                        </h6>
