          ...
          <div className="page-titles acti-space">
            ...
            <div className="d-flex align-items-center flex-wrap">
              ...
              <Dropdown className="me-2 drop-select">
                <Dropdown.Toggle as="div" className="i-false drop-select-btn">
                  {selectBtn} <i className="fa-solid fa-angle-down"></i>
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => setSelectBtn("Recently")}>
                    Recently
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setSelectBtn("This Weeks")}>
                    This Weeks
                  </Dropdown.Item>
                  ...
                  <ul className="timeline-active">
                    <li className="d-flex align-items-baseline timeline-list">
                      ...
                      <div className="panel">
                        ...
                        >
                          <h4>
                            <strong>Karen Hope</strong> has created new task at{" "}
                            <strong>Frize</strong>{" "}
                    ...
                    <li className="d-flex align-items-baseline timeline-list">
                      ...
                      <div className="panel">
                        ...
                        >
                          <h4>
                            <strong className="text-pink">[REMINDER] </strong>{" "}
                            Due date of{" "}
                            <strong className="text-pink">
                              Erempe Studios Projects
                            </strong>{" "}
                            task will be coming
                          </h4>
                        </Link>
                      ...
                      <div className="panel">
                        ...
                        >
                          <h4>
                            ...
                            <strong className="text-pink"> Projects</strong>{" "}
                          </h4>
                        </Link>
                      </div>
                      <span className="time">Monday, June 31 2022</span>
