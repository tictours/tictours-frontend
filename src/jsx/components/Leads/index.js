                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <div className="invoice-btn">
                                        <button className="btn btn-primary" onClick={()=>navigate('/add-lead')}>New Leads <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <td className="whitesp-no p-0">
                                                    <div className="py-sm-3 py-1 ps-3">
                                                        <div >
                                                            ...
                                                            <span className="fs-14 font-w400"><Link to={"app-profile"}>+91 7723823348</Link></span>
                                                        </div>												
                                                    </div>
                                                </td>
                                                <td>Adverisement</td>
                                                ...
                                                <td>
                                                    <Dropdown>
                                                        ...
                                                        <Dropdown.Menu className="dropdown-menu-end">
                                                            <Dropdown.Item onClick={()=>navigate('/add-lead')}>Edit</Dropdown.Item>
