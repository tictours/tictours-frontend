                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <div className="invoice-btn">
                                        <button onClick={()=>setShowModal(true)} className="btn btn-primary">New Payment <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tbody>
                                        {tableBlog.map((item, ind)=>(
                                            <tr key={ind}>
                                                ...
                                                <td className="whitesp-no fs-15 font-w400 text-center">20000</td>
