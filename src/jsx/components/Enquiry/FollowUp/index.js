...
const tableBlog = [
    {  title:'Talan Siphron',  mail:'ahmad@mail.com', icon:'#1EBA62', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Paid'},
    {  title:'Thomas Khun',  mail:'soap@mail.com', icon:'#FF4646', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Paid' },
    ...
    {  title:'Thomas Khun',  mail:'hope@mail.com', icon:'#FF4646', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Paid'  },
    {  title:'Talan Siphron',  mail:'jordan@mail.com' , icon:'#1EBA62', iconClass:'btn-success', icon2: <RightIcon />, icontext:'Paid' },
                            ...
                            <div className="page-titles">
                                ...
                                <div className="d-flex flex-wrap my-2 my-sm-0">
                                    ...
                                    <div className="invoice-btn">
                                        <button onClick={()=>setShowModal(true)} className="btn btn-primary">New Follow Up<svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <table className="table-responsive-lg table display mb-4 dataTablesCard  text-black dataTable no-footer" id="example2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="text-center">Set Reminder</th>
                                    ...
                                    <tbody>
                                        {tableBlog.map((item, ind)=>(
                                            <tr key={ind}>
                                                ...
                                                <td className='w-25 custom-wrap'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</td>
                                                ...
                                                <td className="whitesp-no fs-14 font-w400 text-center">01:00 PM</td>
                                                <td className="whitesp-no font-w400 text-center">Yes</td>
                                                <td className="text-center">Shahid</td>
                                                <td>
                                                    <Dropdown>
