...
const formDataLabel = [
    {title: 'Privacy Policy', id: '12',inputchecked: false},
    {title: 'Contact Us', id: '13',inputchecked: false},
    {title: 'Important Information', id: '14',inputchecked: false},
    {title: 'About Us', id: '15',inputchecked: false},
    {title: 'Dummy Co', id: '16',inputchecked: false},
];

const MenusBlog = () =>{
    const [open, setOpen] = useState(true);
    const [open2, setOpen2] = useState(true);
    const [checked, setChecked] = useState(formDataLabel);
