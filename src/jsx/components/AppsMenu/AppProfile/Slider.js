              ...
              >
                <g opacity="0.4">
                  ...
                  <circle
                    ...
                    cy="24.0209"
                    r="48.8339"
                    transform="rotate(103.889 -3.26671 24.0209)"
                    stroke="#01A3FF"
                  />
                </g>
              </svg>
              ...
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h4 className="fs-15 font-w600 mb-0">
                    ...
                    <h6 className="bg-gray font-w500 mb-0">agent@gmail.com</h6>
                    <h6 className="font-w500">kerala,India</h6>
                </div>
              </div>
              <div className="chart-num">
                {/* <h2 className="font-w600 mb-0 fs-28">2000</h2> */}
                <i class="fa fa-ellipsis-v fa-2xl" aria-hidden="true"></i>
              </div>
            </div>
          </div>
        </SwiperSlide>
        {/* <SwiperSlide>
          <div className="card card-box green">
            <div className="back-image">
              <svg
                width="108"
                height="84"
            ...
            <div className="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div className="chart-num">
                <h2 className="font-w600 mb-0 fs-28">
                   {array[1].value}
                  </h2>
              </div>
            </div>
        ...
        <SwiperSlide>
          <div className="card card-box secondary">
            ...
            <div className="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div className="chart-num">
                <h2 className="font-w600 mb-0 fs-28">78</h2>
              </div>
            </div>
          </div>
        </SwiperSlide>
