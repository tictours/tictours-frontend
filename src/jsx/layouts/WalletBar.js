...
const projectbBar = [
  {
    ...
    title: "Web Design",
    bar: "bg-secondary",
    bartext: "text-secondary",
    time: "452",
  },
  {
    value: "75%",
    title: "Graphic Design",
    bartext: "text-primary",
    time: "97",
  },
  {
    value: "60%",
              ...
              <div className="card bg-transparent contacts mb-1">
                <div className="card-header border-0 pb-0 px-3 pt-2">
                  <div>
                    ...
                    <span>
                      You have <span className="font-w600">456</span> contacts
                    </span>
                  </div>
                  <div>
                    <Link
                ...
                <div
                  className="card-body loadmore-content  recent-activity-wrapper p-3 pt-2"
                ...
                <div className="card-footer text-center border-0 pt-0 px-3">
                  <Link
                    to={"contact"}
                    className="btn btn-block btn-primary  dlab-load-more"
                    id="RecentActivity"
                ...
                <div className="card-header border-0 px-3 pb-0">
                  <div>
                    ...
                    <span className="fs-14 font-w400">
                      You have <strong>456 </strong>contacts
                    </span>
                  </div>
                  <DropDownBlog />
                </div>
                  ...
                  {projectbBar.map((data, ind) => (
                    <div key={ind}>
                      <div className="progress default-progress">
                        <div
                          className={`progress-bar bg-vigit progress-animated  ${data.bar}`}
                      ...
                      <div className="d-flex align-items-end mt-2 pb-4 justify-content-between">
                        <span
                          className={`fs-14 font-w500 value ${data.bartext}`}
                        >
                          {" "}
                          {data.title}
                        </span>
                        <span>
                          <span className="text-black pe-2 font-w500"></span>452
                          times
                        </span>
                      </div>
                    </div>
                ...
                <div className="card-body  p-3">
                  {statusBlog.map((item, index) => (
                    <div className="server-content" key={index}>
                      <div className="progress default-progress">
                        <div
                          className={`progress-bar bg-vigit progress-animated bg-${item.barcolor}`}
                          style={{ width: item.barvalue, height: "100%" }}
                          role="progressbar"
                        >
                          <span className="sr-only">
                            {item.barvalue} Complete
                          </span>
                        </div>
                      </div>
