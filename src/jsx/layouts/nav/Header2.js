              ...
              <li>
                <div className="search-coundry">
                  <Dropdown className="header-drop">
                    <Dropdown.Toggle
                      as="div"
                      className="i-false header-drop-toggle"
                    >
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item
                        onClick={() => setSelectImage([alb, "Albania"])}
                      >
                        <img src={alb} alt="" /> Albania
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => setSelectImage([alg, "Dash Coin"])}
                      >
                        <img src={alg} alt="" /> Dash Coin
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => setSelectImage([usf, "Ripple"])}
                      >
                        <img src={usf} alt="" /> Ripple
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => setSelectImage([rus, "Ethereum"])}
                      >
                        <img src={rus} alt="" /> Ethereum
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
